...
namespace seneca {
   /*
      1- add the template statement to every singe scope in the code
      2- the focus type of the templated class should be change to the type of the template
      3- All the templated class name should carry the signature of the template "<type>" except the following
         I- The name of the class right after the template statement
         II- The constructor names
         III- The destructor name
   
   */

   /// <summary>
   /// Type of the template must implement default constructor
   /// Type of the template must implement copy assignment
   /// The Type must be instertable into ostream
   /// </summary>
