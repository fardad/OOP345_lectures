...
int main( ) {
   ...
   size_t chips = count( E.begin( ), E.end( ), "Chip" );
   cout << "There are " << chips << " employees with the name Chip" << endl;

   size_t num = count_if( E.begin( ), E.end( ), []( const Employee& E ) {return E > 80000.00; } );
   ...
   sort( E.begin( ), E.end( ), []( const Employee& a, const Employee& b ) {return b > a; } );
