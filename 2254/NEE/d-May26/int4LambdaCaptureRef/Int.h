...
class Int {
   ...
   std::function<bool(int, std::string&)>lamdaValid = nullptr;
public:
   Int(std::function<bool(int, std::string&)>lamdaValidArg = nullptr);
   void set(std::function<bool(int, std::string&)> lamdaValidArg);
